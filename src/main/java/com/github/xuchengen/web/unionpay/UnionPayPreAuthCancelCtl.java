 ...
 */
@Controller
@RequestMapping(value = "/unionPay/onlineGatewayPay/preAuthCancel")
public class UnionPayPreAuthCancelCtl extends BaseCtl {

    private static final Log log = LogFactory.get(UnionPayPreAuthCancelCtl.class);

    @GetMapping(value = {"", "/"})
    public String index(ModelMap modelMap) {
        modelMap.put("notifyUrl", getHostUrl() + "/unionPay/doNotify");
        return "/unionpay/onlineGateway/preAuthCancel.html";
    }
    ...
    public ResponseResult doCancel(String orderNo,
        ...
        try {
            ...
            unionPayBackTransRequest.setTxnType("32");
            ...
            log.error("调用银联在线网关支付预授权撤销接口异常：{}", JSONUtil.toJsonStr(e));
