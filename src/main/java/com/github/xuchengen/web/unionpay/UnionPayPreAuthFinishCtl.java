 ...
 */
@Controller
@RequestMapping(value = "/unionPay/onlineGatewayPay/preAuthFinish")
public class UnionPayPreAuthFinishCtl extends BaseCtl {

    private static final Log log = LogFactory.get(UnionPayPreAuthFinishCtl.class);

    @GetMapping(value = {"", "/"})
    public String index(ModelMap modelMap) {
        modelMap.put("notifyUrl", getHostUrl() + "/unionPay/doNotify");
        return "/unionpay/onlineGateway/preAuthFinish.html";
    }

    @PostMapping(value = "/doFinish")
    @ResponseBody
    public ResponseResult doFinish(String orderNo,
                                   String origNo,
        ...
        try {
            ...
            unionPayBackTransRequest.setTxnType("03");
            ...
            log.error("调用银联在线网关支付预授权完成接口异常：{}", JSONUtil.toJsonStr(e));
