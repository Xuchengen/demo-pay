...
import com.demo.pay.unionpay.response.UnionPayPreAuthResponse;
 ...
 * 日期：2019/8/30
 */
public class UnionPayPreAuthRequest extends UnionPayCommonRequest implements UnionPayRequest<UnionPayPreAuthResponse> {
    ...
    @Override
    public Class<UnionPayPreAuthResponse> getResponseClass() {
        return UnionPayPreAuthResponse.class;
    }
}
