...
import com.demo.pay.unionpay.response.UnionPayPreAuthFinishBackResponse;

/**
 * 在线网关支付--预授权完成撤销接口请求模型
 * 作者：徐承恩
 * 邮箱：xuchengen@gmail.com
 * 日期：2019/8/30
 */
public class UnionPayPreAuthFinishBackRequest extends UnionPayCommonRequest implements UnionPayRequest<UnionPayPreAuthFinishBackResponse> {
    ...
    @Override
    public Class<UnionPayPreAuthFinishBackResponse> getResponseClass() {
        return UnionPayPreAuthFinishBackResponse.class;
    }
}
