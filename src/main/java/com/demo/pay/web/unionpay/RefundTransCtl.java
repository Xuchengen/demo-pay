 ...
 */
@Controller
@RequestMapping(value = "/unionpay/refundTrans")
public class RefundTransCtl extends BaseCtl {

    private static final Log log = LogFactory.get(RefundTransCtl.class);
    ...
    public ResponseWrapper index() {
        try {
            ...
            unionPayRefundTransRequest.setOrderId("20190829195302863196");
            unionPayRefundTransRequest.setOrigQryId("081908291953282787528");
            unionPayRefundTransRequest.setTxnAmt("100");
            unionPayRefundTransRequest.setTxnType("04");
            ...
            unionPayRefundTransRequest.setBackUrl(getHostUrl() + "/unionpay/backTrans/notify");
    ...
    public String doNotify() {
        ...
        if (verify) {
            log.debug("接收银联异步回调通知：退货接口[验签成功]");
            return "OK";
        }
